...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{route('frontend.home')}}" target="_blank" class="nav-link">Back To Application</a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{route('admin.dashboard')}}" class="brand-link">
            ...
            <span class="brand-text font-weight-light">E3DB</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <div class="float-right d-none d-sm-inline">
            E3mel Business Database
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; 2021 <a href="https://www.e3melbusiness.com">E3mel Business</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
